...
daps = {
    ...
    'lspi '   , @lspi   , struct('N', 5, 'M', 75, 'T', 20, 'v_basis', '1a', 'resample', true, 'transform', polynomial(3));
    ...
    'klspi'   , @klspi  , struct('N', 5, 'M', 90, 'T', 07, 'v_basis', '1a', 'resample', true, 'kernel', k_gaussian(k_norm(),0.5), 'mu', 0.3);
