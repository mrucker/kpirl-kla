...
for i = 1:200
    ...
    daps = {
        ...
        'klspi, bandwidth=0.25'         , @klspi  , struct('N', 30, 'M', 90 , 'T', 06, 'v_basis', '1a', 'resample', true, 'kernel', k_gaussian(k_norm(),0.25), 'mu', 0.3);
        'klspi, bandwidth=0.50'         , @klspi  , struct('N', 30, 'M', 90 , 'T', 06, 'v_basis', '1a', 'resample', true, 'kernel', k_gaussian(k_norm(),0.50), 'mu', 0.3);
        'klspi, bandwidth=1.00'         , @klspi  , struct('N', 30, 'M', 90 , 'T', 06, 'v_basis', '1a', 'resample', true, 'kernel', k_gaussian(k_norm(),1.00), 'mu', 0.3);
    }';
