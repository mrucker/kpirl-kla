...
attributes = { reward_iteration_index() policy_iteration_index() policy_value(domain, n_samps, n_steps, gamma) policy_time() };
statistics = { };
...
daps = {
    ...
    'random'  , @kla_spd, struct('N', 45, 'M', 01 , 'T', 01, 'v_basis', '1b', 'W', 00);
    ...
    'lspi '   , @lspi   , struct('N', 45, 'M', 75, 'T', 20, 'v_basis', '1a', 'resample', true, 'transform', polynomial(3));
